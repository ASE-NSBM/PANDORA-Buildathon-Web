...
/**
 * The full team-registration flow (crew manifest + per-member form + success
 * screen). Background-neutral so it can sit on the /register page or inline on
 * the home page. Toasts rely on the <Toaster /> mounted in the root layout.
 */

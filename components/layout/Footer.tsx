...
export default function Footer() {
  return (
    <footer id="contact" className="bg-midnight-blue border-t border-white/10 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-cinzel font-semibold text-bright-cyan text-xs tracking-[0.2em] uppercase mb-4">
              Quick Links
            </h4>

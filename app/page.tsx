...
import ScrollVideoSection from '@/components/ui/ScrollVideoSection'
...
export default function HomePage() {
  return (
    <>
      {/* ── Section 1: Hero ─ clip1 ── */}
      <ScrollVideoSection
        src="/vids/clip1.mp4"
        scrollHeight="300vh"
        overlay={0.5}
        contentClassName="flex flex-col items-center justify-center text-center px-4 pt-16"
      >
      ...
      {/* ── Section 3: Why Participate ─ clip3 ── */}
      <ScrollVideoSection
        src="/vids/clip3.mp4"
        scrollHeight="250vh"
        overlay={0.65}
      ...
      {/* ── Section 4: Final CTA ─ clip4 ── */}
      <ScrollVideoSection
        src="/vids/clip4.mp4"
        scrollHeight="200vh"
        overlay={0.45}
        contentClassName="flex flex-col items-center justify-center text-center px-4"
        id="contact"
      >

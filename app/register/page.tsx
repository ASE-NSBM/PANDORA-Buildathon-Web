    ...
    <>
      ...
      <section className="relative pt-32 pb-12 overflow-hidden min-h-[38vh] flex items-center">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 text-center">
          <p className="font-display text-bright-cyan text-xs tracking-[0.3em] uppercase mb-4">Join Buildathon 2026</p>
          <h1 className="section-heading text-4xl sm:text-5xl md:text-6xl mb-4">Assemble Your Crew</h1>
